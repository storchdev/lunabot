...
class RedeemButton(ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        layout = self.bot.get_layout("se/redeem/success")
...
class DailyTasksView(View):
    ...
    async def send(self, edit=False):
        ...
        embed = self.bot.get_embed("se/dailyadvent")
    ...
    async def claim_all(self, interaction, button):
        ...
        await self.update_self()
        layout = self.bot.get_layout("se/dailies/claimed")
        repls = {
            "points": points,
    ...
    async def claim_bonus(self, interaction, button):
        ...
        await self.update_self()
        # send layout
        layout = self.bot.get_layout("se/dailies/bonusclaimed")
