...
class EditEmbedModal(BaseModal, title='Edit Main Properties'):
    _title = discord.ui.TextInput[Self](
        label='Title', placeholder='Limit 256 characters.', max_length=256, required=False
    )
    ...
    image = discord.ui.TextInput[Self](label='Image URL', placeholder='Must start with http(s)', required=False)
    ...
    def update_embed(self):
        ...
        if self.color.value:
            try:
                ...
                failed.append('Invalid color! Must be in the form #FFFFFF or rgb(num, num, num).')
        else:
...
class EditAuthorModal(BaseModal, title='Edit Author'):
    ...
    url = discord.ui.TextInput[Self](label="Author URL", placeholder='Must start with http(s)', required=False)
    image = discord.ui.TextInput[Self](label='Author Icon URL', placeholder='Must start with http(s)', required=False)
...
class EditFooterModal(BaseModal, title='Edit Footer:'):
    text = discord.ui.TextInput[Self](
        label='Footer text', max_length=256, placeholder='Limit 256 characters.', required=False
    )
    image = discord.ui.TextInput[Self](label='Footer icon URL', placeholder='Must start with http(s)', required=False)
...
class AddFieldModal(BaseModal, title='Add a field:'):
    ...
    inline = discord.ui.TextInput[Self](
        label='Inline?', placeholder='[yes/no] (Default: Yes)', max_length=4, required=False
    )
